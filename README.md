...
![gambar output](image/daftarrayhan.png)

- view_nilai.py berisi modul untuk: cetak_daftar_nilai, cetak_hasil_pencarian

![gambar output](image/viewrayhan.png)

- input_nilai.py berisi modul untuk: input_data yang meminta pengguna memasukkan data.
![gambar output](image/inputrayhan.png)

- main.py berisi program utama (menu pilihan yang memanggil semua menu yang ada
![gambar output](image/mainrayhan.png)

- hasil dari inputan program 
![gambar output](image/hasilrayhan.png)
